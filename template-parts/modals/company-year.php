<form action="" method="post" class="modal-content" method="post" data-form="comp-year">
	<h3 class="text-center">Company of the Year</h3><hr>
	...
	<input type="hidden" name="form-name" value="company-year">
</form>