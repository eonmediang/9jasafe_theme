<form action="" method="post" class="modal-content" method="post" data-form="merit">
	<h3 class="text-center">Merit Awards</h3><hr>
	...
	<input type="hidden" name="form-name" value="merit">
</form>