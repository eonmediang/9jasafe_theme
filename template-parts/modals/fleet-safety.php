<form action="" method="post" class="modal-content" method="post" data-form="fleet-safety">
	<h3 class="text-center">Fleet Safety</h3><hr>
	...
	<input type="hidden" name="form-name" value="fleet-safety">
</form>