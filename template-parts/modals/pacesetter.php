<form action="" method="post" class="modal-content" method="post" data-form="pacesetter">
	<h3 class="text-center">Corporate Pacesetter Award</h3><hr>
	<div class="container-fluid">
		<div class="row">
		 	<div class="form-group col-sm-6">
		 		<label for="p_org_name" class="sr-only">Company/Organisation name</label>
		 		<p>Company/Organisation name</p>
		 		<input class="form-control required" type="text" id="p_org_name" name="p_org_name" placeholder="Company/Organisation name" required>
			</div>
			<div class="form-group col-sm-6">
	...
	<input type="hidden" name="form-name" value="pacesetter">
</form>