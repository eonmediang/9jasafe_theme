<form action="" method="post" class="modal-content" method="post" data-form="guardian">
	<h3 class="text-center">Guardian Angel</h3><hr>
	...
	<input type="hidden" name="form-name" value="guardian">
</form>