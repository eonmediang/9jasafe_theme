<form action="" method="post" class="modal-content" method="post" data-form="commendation">
	<h3 class="text-center">Commendation Awards</h3><hr>
	...
	<input type="hidden" name="form-name" value="commendation">
</form>