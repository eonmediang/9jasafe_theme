<form action="" method="post" class="modal-content" method="post" data-form="school-safety">
	<h3 class="text-center">School Safety Awards</h3><hr>
	<div class="container-fluid">
		<div class="row">
		 	<div class="form-group col-sm-6">
		 		<label for="p_org_name" class="sr-only">Nominee's name</label>
		 		<p>Nominee's name</p>
		 		<input class="form-control required" type="text" id="p_org_name" name="p_org_name" placeholder="School's name" required>
			</div>
			<div class="form-group col-sm-6">
		...
		<div class="row">
		 	...
		 	<div class="form-group col-sm-6">
				<label for="address" class="sr-only">Contact address (if available)</label>
				<p>Contact address (if available)</p>
	...
	<input type="hidden" name="form-name" value="school-safety">
</form>